...
public class ThreeOfAKindKickersComparisonResultCalculatorImplTest {
    ...
    public void testHighestThreeOfAKindCardCategoryKickerComparison() {
        ...
        Assert.assertEquals(threeOfAKindKickersComparisonResultCalculator.calculateKickersComparisonResult(threeOfAKindKickers1, threeOfAKindKickers2), KickersComparisonResult.DEALER_WINS);
        Assert.assertEquals(threeOfAKindKickersComparisonResultCalculator.calculateKickersComparisonResult(threeOfAKindKickers2, threeOfAKindKickers1), KickersComparisonResult.BIG_BLIND_WINS);
    }
