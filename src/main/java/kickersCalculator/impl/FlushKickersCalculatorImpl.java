...
public class FlushKickersCalculatorImpl implements FlushKickersCalculator {
    @Override
    public FlushKickers calculateKickers(final Hand hand, final SortedCardCategoryReturner sortedCardCategoryReturner) throws IncorrectNumberOfCardCategoriesException {
